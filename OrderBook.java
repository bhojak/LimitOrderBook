...
public class OrderBook {
    ...
    public void addOrder(int orderId, double price, String orderType , int qty ){
        Order order = new Order(orderId, price ,orderType, qty); // assuming the system is using unique orderId and none of the order fields are blank.
